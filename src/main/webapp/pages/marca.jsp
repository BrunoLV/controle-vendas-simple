...
<body style="background-color: #61A2FF;">
	...
	<div class="container">
		...
		<div id="starter-template">
			...
			<div class="panel panel-primary" id="cadastroMarcaDiv">
				<div class="panel-heading">
					<h3 class="panel-title">Cadastro de Marca</h3>
				</div>
				<div class="panel-body">
					<form id="marcaCadastroForm">
						<input id="marcaId" type="hidden" />
						<fieldset>
							<div class="row">
								<div class="col-xs-6">
									<div class="form-group">
										<label for="marcaNome">Nome:</label> 
										<input id="marcaNome" class="form-control" type="text" style="width: 100%" />
									</div>
								</div>
							</div>
						</fieldset>
			...
			<div class="panel panel-primary" id="listagemMarcaDiv">
				<div class="panel-heading">
					<h3 class="panel-title">Lista de Marcas</h3>
				</div>
				<table class="table-condensed table-hover table-striped" id="marcasTable">
	...
	<script src="<c:out value='${pageContext.request.contextPath}/js/marca-funcoes.js'/>"></script>
</body>
</html>